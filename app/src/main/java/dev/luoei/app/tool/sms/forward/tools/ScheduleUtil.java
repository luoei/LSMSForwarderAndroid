...
//                    Log.d("定时器","当前时间"+new Date());
                    ...
                    if (null != CommonParas.getMailAccount().getPhone() && (System.currentTimeMillis() - lastTime)/1000 > 20*24*3600){
                        ...
                        editor.commit();
                        new SMSService().sender(CommonParas.getMainContext(), CommonParas.getMailAccount().getPhone(),"短信签到，时间："+new Date());
